    ...
    <div class="cart-modal">
      ...
      <div class="cart-modal__body">
        <div class="cart-item">
          ...
          <div class="cart-item__contols">
            <div class="cart-item__contols--price">250 ₽</div>
            <button class="btn btn-outline">-</button>
            <div class="cart-item__contols--count">1</div>
            <button class="btn btn-outline">+</button>
          </div>
        </div>
        <div class="cart-item">
...
.cart-item__contols button {
  border: 1px solid #40a9ff;
  color: #40a9ff;
}

.cart-item__contols--count {
  margin-left: 15px;
  margin-right: 15px;
}
</style>
